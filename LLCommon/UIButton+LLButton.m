...
+ (instancetype)ll_buttonWithNormalBackgroundImageName:(NSString *)normalBackgroundImageName highlightedBackgroundImageImage:(NSString *)highlightedBackgroundImageImage{
    return [self ll_buttonWithNormalBackgroundImageName:normalBackgroundImageName selectedBackgroundImageName:nil highlightedBackgroundImageImage:highlightedBackgroundImageImage focusedBackgroundImageName:nil disableBackgroundImageName:nil];
}
...
+ (instancetype)ll_buttonWithNormalBackgroundImageName:(NSString *)normalBackgroundImageName selectedBackgroundImageName:(NSString *)selectedBackgroundImageName{
    return [self ll_buttonWithNormalBackgroundImageName:normalBackgroundImageName selectedBackgroundImageName:selectedBackgroundImageName highlightedBackgroundImageImage:nil focusedBackgroundImageName:nil disableBackgroundImageName:nil];
}
